...
UE_DEFINE_GAMEPLAY_TAG(TAG_UI_Screen_InGameMenu_Trigger, "UI.Screen.InGameMenu.Trigger");
UE_DEFINE_GAMEPLAY_TAG(TAG_UI_Screen_InGameMenu_Block, "UI.Screen.InGameMenu.Block");
UE_DEFINE_GAMEPLAY_TAG(TAG_UI_Screen_InGameMenu_Map, "UI.Screen.InGameMenu.Map");
